...
public class Porta {
	...
	private int sala1;
	private int sala2;
	private boolean status = true; //true-aberta/false-fechada
	private boolean feitico = true; //false-trancada por feitiço/true-n enfeitiçada
	
	public Porta(){}
	
	public Porta(char nome1, char nome2, int sala1, int sala2) {
		this.nome1 = nome1;
		this.nome2 = nome2;
		this.sala1 = sala1;
		this.sala2 = sala2;
